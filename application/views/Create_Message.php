  ...
  <body>
    ...
    <div class="panel panel-info">
      <div class="panel-heading">
        <h4><center><strong>建立新留言</strong></center></h4>
      </div>
    ...
    <div class="input-group">
        ...
        <input type="text" class="form-control" name="message" placeholder="訊息"
    ...
    <button type="submit" class="btn btn-success">發布新留言</button>
